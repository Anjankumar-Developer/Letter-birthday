export const birthdayConfig = {
  ...
  hero: {
    title: "Happy Birthday, Jaanu ❤️",
    subtitle: "Today is your day. But somehow, you still managed to become my favorite part of it.",
  },
  ...
  memories: [
    {
      ...
      caption: "This Picture still makes me smile.",
      date: ""
    },
    {
...
"Simply because you're you. And if I had to choose again, in every version of this life, I'd still choose you. ❤️"
  ...
  secrets: [
    {
      icon: "heart",
      message: "You are the best thing that ever happened to me. ❤️"
    },
    {
      icon: "star",
      message: "You shine brighter than any star in the night sky. ✨"
    },
    {
      icon: "moon",
    ...
    {
      icon: "camera",
      message: "Every picture of you is my new favorite picture. 📸"
    }
  ],
...
❤️`,
  ...
  finalMessage: {
    prelude: "I don't know what the future has planned for us...",
    climax: "...but I know I want as much of it with you as possible.",
    outro: "I love you."
  }
};
